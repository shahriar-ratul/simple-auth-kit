...
export class AdminController {
  ...
  async deleteCountry(
    ...
    await this.admin.deleteCountry(req.authz!.workspaceId, countryId, req.auth!.sub, optionalString(body?.reason));
    return { ok: true };
  }
  ...
  async activateCountry(@Param('countryId') countryId: string, @Req() req: Request) {
    await this.admin.activateCountry(req.authz!.workspaceId, countryId, req.auth!.sub);
    return { ok: true };
  }
  ...
  async deactivateCountry(@Param('countryId') countryId: string, @Req() req: Request) {
    await this.admin.deactivateCountry(req.authz!.workspaceId, countryId, req.auth!.sub);
    return { ok: true };
  }
  ...
  async deleteLanguage(
    ...
    await this.admin.deleteLanguage(req.authz!.workspaceId, languageId, req.auth!.sub, optionalString(body?.reason));
    return { ok: true };
  }
  ...
  async activateLanguage(@Param('languageId') languageId: string, @Req() req: Request) {
    await this.admin.activateLanguage(req.authz!.workspaceId, languageId, req.auth!.sub);
    return { ok: true };
  }
  ...
  async deactivateLanguage(@Param('languageId') languageId: string, @Req() req: Request) {
    await this.admin.deactivateLanguage(req.authz!.workspaceId, languageId, req.auth!.sub);
    return { ok: true };
  }
  ...
  async deleteCustomer(
    ...
    await this.admin.deleteCustomer(req.authz!.workspaceId, customerId, req.auth!.sub, optionalString(body?.reason));
    return { ok: true };
  }
  ...
  async activateCustomer(@Param('customerId') customerId: string, @Req() req: Request) {
    await this.admin.activateCustomer(req.authz!.workspaceId, customerId, req.auth!.sub);
    return { ok: true };
  }
  ...
  async deactivateCustomer(@Param('customerId') customerId: string, @Req() req: Request) {
    await this.admin.deactivateCustomer(req.authz!.workspaceId, customerId, req.auth!.sub);
    return { ok: true };
  }
}
