// DTOs for the admin surface: user management, block/activate, and user-scoped role/permission
...
/** `PATCH /admin/users/:userId` — the admin-surface edit. Self-service profile edits (`PATCH /auth/me`) have their own, narrower `UpdateUserDto` in auth.dto.ts. */
