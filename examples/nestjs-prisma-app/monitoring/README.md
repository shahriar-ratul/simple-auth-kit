...
|               |                                                                          |
| ------------- | ------------------------------------------------------------------------ |
| Grafana       | <http://localhost:3031> — dashboard provisioned, nothing to import       |
| Prometheus    | <http://localhost:9091> — _Status > Target health_ when a panel is empty |
| node_exporter | <http://localhost:9101/metrics>                                          |

Prometheus reaches the application at `host.docker.internal:3001`, because the app runs on
