...
import { PERMISSION_SLUGS, type PermissionSlug } from '../../src/modules/auth/permission-slugs.js';
 ...
 * just leaves the seeded workspace with no role that carries the catalog. And `member` is the default a
