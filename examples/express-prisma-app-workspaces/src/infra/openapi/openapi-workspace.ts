  ...
  scopeParameters: [
    {
      ...
      required: false,
      description: 'Answer for this workspace. Omitted, `roles` and `permissions` come back empty.',
    },
  ],
  ...
  schemas: {
    ...
    AddMemberRequest: {
      ...
      properties: {
        email: {
          type: 'string',
          description: 'Must already be a registered user — this library has no invite flow',
        },
        roles: {
          type: 'array',
          items: { type: 'string' },
