...
export class AuthClient {
  ...
  async signup(input: {
    ...
    const tokens = await this.anonymousRequest<AuthTokens>(
      "POST",
      "/api/v1/auth/signup",
      input,
    );
  ...
  async login(input: {
    ...
    const result = await this.anonymousRequest<AuthTokens | TwoFactorChallenge>(
      "POST",
      "/api/v1/auth/login",
      input,
    );
  ...
  async refresh(): Promise<AuthTokens> {
    ...
    const rotated = await this.anonymousRequest<{
      accessToken: string;
      refreshToken: string;
  ...
  async logoutOthers(): Promise<void> {
    await this.request("POST", "/api/v1/auth/logout-others");
  }
  ...
  async changePassword(input: {
    ...
    await this.request("POST", "/api/v1/auth/password/change", input);
  }
  ...
  async updateProfile(input: UpdateUserInput): Promise<SelfProfile> {
    return this.request("PATCH", "/api/v1/auth/me", input);
  }
  ...
  async me(scope?: WorkspaceScope): Promise<CurrentUser> {
    return this.scopedRequest("GET", "/api/v1/auth/me", undefined, scope);
  }
  ...
  async enrollTwoFactor(): Promise<{
    ...
    return this.request("POST", "/api/v1/auth/2fa/enroll");
  }

  async confirmTwoFactor(code: string): Promise<{ backupCodes: string[] }> {
    return this.request("POST", "/api/v1/auth/2fa/confirm", { code });
  }

  async disableTwoFactor(code: string): Promise<void> {
    await this.request("POST", "/api/v1/auth/2fa/disable", { code });
  }

  async requestPasswordReset(input: { email: string }): Promise<void> {
    await this.anonymousRequest("POST", "/api/v1/auth/password/forgot", input);
  }
  ...
  async resetPassword(input: {
    ...
    await this.anonymousRequest("POST", "/api/v1/auth/password/reset", input);
  }
  ...
  async setWorkspaceMemberRoles(
    ...
    return this.scopedRequest(
      "PUT",
      `/api/v1/workspaces/members/${encodeURIComponent(memberId)}/roles`,
      { roles },
      scope,
    );
  }
  ...
  async removeWorkspaceMember(
    ...
    await this.scopedRequest(
      "DELETE",
      `/api/v1/workspaces/members/${encodeURIComponent(memberId)}`,
      undefined,
      scope,
    );
  }
  ...
  async activateUser(userId: string, scope?: WorkspaceScope): Promise<void> {
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/users/${encodeURIComponent(userId)}/activate`,
      undefined,
      scope,
    );
  }
  ...
  async listUsers(
    ...
    return this.scopedRequest<UserListResult>(
      "GET",
      `/api/v1/admin/users${queryString(filter)}`,
      undefined,
      scope,
    );
  }
  ...
  async createUser(
    ...
    return this.scopedRequest("POST", "/api/v1/admin/users", input, scope);
  }
  ...
  async listRoles(
    ...
    const result = await this.scopedRequest<{ roles: RoleSummary[] }>(
      "GET",
      `/api/v1/roles${queryString(filter)}`,
      undefined,
      scope,
    );
    return result.roles;
  ...
  async createRole(
    ...
    return this.scopedRequest("POST", "/api/v1/roles", input, scope);
  }
  ...
  async detachPermissionFromRole(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/roles/${encodeURIComponent(roleId)}/permissions/${encodeURIComponent(permissionSlug)}/revoke`,
      undefined,
      scope,
    );
  }
   ...
   * every gated admin/roles/permissions/audit-log route sits behind the same guard that requires `X-Workspace-Id`, even
  ...
  async listPermissions(
    ...
    const result = await this.scopedRequest<PermissionListResult>(
      "GET",
      `/api/v1/permissions${queryString(filter)}`,
      undefined,
      scope,
    );
  ...
  async definePermission(
    ...
    return this.scopedRequest("POST", "/api/v1/permissions", input, scope);
  }
  ...
  async revokeRole(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/users/${encodeURIComponent(userId)}/roles/${encodeURIComponent(roleName)}/revoke`,
      undefined,
      scope,
    );
  }
  ...
  async revokePermission(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/users/${encodeURIComponent(userId)}/permissions/${encodeURIComponent(permissionKey)}/revoke`,
      undefined,
      scope,
    );
  }
  ...
  async listCountries(
    ...
    return this.scopedRequest<CountryListResult>(
      "GET",
      `/api/v1/admin/countries${queryString(filter)}`,
      undefined,
      scope,
    );
  }
  ...
  async createCountry(
    ...
    return this.scopedRequest("POST", "/api/v1/admin/countries", input, scope);
  }
  ...
  async getCountry(
    ...
    return this.scopedRequest(
      "GET",
      `/api/v1/admin/countries/${encodeURIComponent(countryId)}`,
      undefined,
      scope,
    );
  }
  ...
  async activateCountry(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/countries/${encodeURIComponent(countryId)}/activate`,
      undefined,
      scope,
    );
  }
  ...
  async deactivateCountry(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/countries/${encodeURIComponent(countryId)}/deactivate`,
      undefined,
      scope,
    );
  }
  ...
  async listLanguages(
    ...
    return this.scopedRequest<LanguageListResult>(
      "GET",
      `/api/v1/admin/languages${queryString(filter)}`,
      undefined,
      scope,
    );
  }
  ...
  async createLanguage(
    ...
    return this.scopedRequest("POST", "/api/v1/admin/languages", input, scope);
  }
  ...
  async getLanguage(
    ...
    return this.scopedRequest(
      "GET",
      `/api/v1/admin/languages/${encodeURIComponent(languageId)}`,
      undefined,
      scope,
    );
  }
  ...
  async activateLanguage(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/languages/${encodeURIComponent(languageId)}/activate`,
      undefined,
      scope,
    );
  }
  ...
  async deactivateLanguage(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/languages/${encodeURIComponent(languageId)}/deactivate`,
      undefined,
      scope,
    );
  }
  ...
  async listCustomers(
    ...
    return this.scopedRequest<CustomerListResult>(
      "GET",
      `/api/v1/admin/customers${queryString(filter)}`,
      undefined,
      scope,
    );
  }
  ...
  async createCustomer(
    ...
    return this.scopedRequest("POST", "/api/v1/admin/customers", input, scope);
  }
  ...
  async activateCustomer(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/customers/${encodeURIComponent(customerId)}/activate`,
      undefined,
      scope,
    );
  }
  ...
  async deactivateCustomer(
    ...
    await this.scopedRequest(
      "POST",
      `/api/v1/admin/customers/${encodeURIComponent(customerId)}/deactivate`,
      undefined,
      scope,
    );
  }
  ...
  private async anonymousRequest<T>(
    method: string,
    path: string,
    body?: unknown,
  ): Promise<T> {
  ...
  private async scopedRequest<T>(
    ...
    return this.authedRequest<T>(
      ...
      path,
      body,
      await this.resolveWorkspaceId(scope),
    );
  }
