...
// CoreAuthModule.forRoot()'s JwtModule.registerAsync — see core-auth.module.ts). No database, no
// generation, no rotation — changing it invalidates every outstanding token.
