...
import {
  ...
  workspaceSpec,
} from "@/infra/openapi/openapi-workspace";
...
export const adminSpec: OpenApiFragment = {
  ...
  schemas: {
    ...
    CreateUserRequest: {
      ...
      description:
        "No invitation email — the account is usable immediately with the password given here, and it is added to this workspace in the same step.",
      properties: {
        ...
        roles: {
          ...
          items: { type: "string" },
          description:
            "Role slugs to assign in this workspace. Defaults to whichever roles are flagged isDefault, same as addMember.",
        },
      },
    },
    UpdateUserRequest: {
      type: "object",
      description:
        "Profile fields only — email is the login identifier and is not editable here. Any field may be sent as `null` to clear it.",
      properties: {
    ...
    DeleteReasonRequest: {
      ...
      properties: {
        reason: {
          type: "string",
          description:
            "Free-text note recorded alongside the soft-delete, for whoever reads the row later.",
        },
      },
    },
    RoleSummary: {
    ...
    MemberSummary: {
      ...
      properties: {
        ...
        updatedAt: {
          type: "string",
          format: "date-time",
          description: "When the underlying user account was last updated",
        },
      },
    },
    PageMeta: {
