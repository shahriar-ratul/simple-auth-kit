...
ALTER TABLE "permission_member" ADD CONSTRAINT "permission_member_member_id_workspace_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."workspace_members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "permission_member" ADD CONSTRAINT "permission_member_permission_id_permissions_id_fk" FOREIGN KEY ("permission_id") REFERENCES "public"."permissions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "role_member" ADD CONSTRAINT "role_member_member_id_workspace_members_id_fk" FOREIGN KEY ("member_id") REFERENCES "public"."workspace_members"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "role_member" ADD CONSTRAINT "role_member_role_id_roles_id_fk" FOREIGN KEY ("role_id") REFERENCES "public"."roles"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "permission_member_permission_id_idx" ON "permission_member" USING btree ("permission_id");--> statement-breakpoint
...
CREATE INDEX "role_member_role_id_idx" ON "role_member" USING btree ("role_id");--> statement-breakpoint
CREATE UNIQUE INDEX "roles_uuid_key" ON "roles" USING btree ("uuid");--> statement-breakpoint
CREATE UNIQUE INDEX "roles_workspace_id_slug_key" ON "roles" USING btree ("workspace_id","slug");--> statement-breakpoint
CREATE INDEX "roles_workspace_default_idx" ON "roles" USING btree ("workspace_id","is_default");--> statement-breakpoint
...
CREATE UNIQUE INDEX "workspace_members_uuid_key" ON "workspace_members" USING btree ("uuid");--> statement-breakpoint
CREATE UNIQUE INDEX "workspace_members_user_id_workspace_id_key" ON "workspace_members" USING btree ("user_id","workspace_id");--> statement-breakpoint
CREATE INDEX "workspace_members_workspace_id_idx" ON "workspace_members" USING btree ("workspace_id");--> statement-breakpoint
CREATE UNIQUE INDEX "workspaces_uuid_key" ON "workspaces" USING btree ("uuid");--> statement-breakpoint
CREATE INDEX "workspaces_is_deleted_idx" ON "workspaces" USING btree ("is_deleted");