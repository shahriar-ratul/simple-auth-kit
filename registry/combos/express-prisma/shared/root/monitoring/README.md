...
|               |                                                                          |
| ------------- | ------------------------------------------------------------------------ |
| Grafana       | <http://localhost:3033> — dashboard provisioned, nothing to import       |
| Prometheus    | <http://localhost:9093> — _Status > Target health_ when a panel is empty |
| node_exporter | <http://localhost:9103/metrics>                                          |

Prometheus reaches the application at `host.docker.internal:3003`, because the app runs on
