  ...
  paths: {
    ...
    "/admin/authz-cache": {
      get: {
        ...
        description: `${requiresPermission("authz-cache:manage")} Configuration, current authz_version, hit/resolution counts since process start, and — when the store can list — the cached entries.`,
        security: [{ bearerAuth: [] }],
        responses: {
          "200": {
            description: "OK",
    ...
    "/admin/authz-cache/clear": {
      post: {
        ...
        description: `${requiresPermission("authz-cache:manage")} Bumps authz_version (invalidating every entry on every server), then deletes the stored entries when the store can.`,
        security: [{ bearerAuth: [] }],
        responses: {
          "201": {
            description: "Created",
