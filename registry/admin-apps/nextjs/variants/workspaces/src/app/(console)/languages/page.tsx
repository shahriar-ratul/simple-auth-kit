...
export default observer(function LanguagesPage() {
  ...
  // `activeWorkspaceId` is part of the query key, same reasoning as the users list: languages are
  // workspace-scoped, so switching workspace has to re-fetch rather than leave the previous
  // workspace's languages on screen.
