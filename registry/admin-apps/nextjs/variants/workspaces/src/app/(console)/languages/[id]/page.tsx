...
export default observer(function LanguageDetailPage() {
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <div>
                ...
                <CardDescription>
                  Created: {new Date(language.createdAt).toLocaleDateString()} · Updated: {new Date(language.updatedAt).toLocaleDateString()}
                </CardDescription>
              </div>
