...
import { type CountryFormValues } from "../../country-schema";
...
export default observer(function EditCountryPage() {
  ...
  const [form, setForm] = useState<CountryFormValues | null>(null);
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 w-full">
              <Card className="w-full">
                ...
                <CardContent className="pt-6">
                  <PhotoUpload photo={form.flag} fallback={form.emoji || "?"} onChange={(next) => set("flag", next)} disabled={saving} />
                </CardContent>
