...
const EditPermissionPage = observer(function EditPermissionPage() {
  ...
  const [form, setForm] = useState<PermissionFormValues | null>(null);
  ...
  useEffect(() => {
    if (!canDefine || !activeWorkspaceId) return;
    setLoading(true);
  ...
  }, [canDefine, activeWorkspaceId, id]);
  ...
  // Same pick-or-create flow as the add page: a known group derives its existing ordering, a new
  // group starts a fresh one.
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    setSaving(true);
    try {
      // Editing is an upsert keyed on slug — the slug itself can't change here.
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="flex flex-col gap-1.5">
                          ...
                          <Input id="slug" disabled placeholder="billing:manage" value={form.slug} type="text" className={inputClassName} />
                        </div>
                        <div className="flex flex-col gap-1.5">
