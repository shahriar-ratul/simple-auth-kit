...
function CommandAddItem({
	...
	return (
		<div
			...
			className={cn(
				"flex w-full text-blue-500 cursor-pointer text-sm px-2 py-1.5 rounded-sm items-center focus:outline-hidden",
...
export function Combobox({
	...
	return (
		<Popover open={open} onOpenChange={setOpen}>
			...
			<PopoverContent
				className={cn("w-full min-w-[500px] p-0", popoverClassName)}
			>
				<Command
					filter={(value, search) => {
