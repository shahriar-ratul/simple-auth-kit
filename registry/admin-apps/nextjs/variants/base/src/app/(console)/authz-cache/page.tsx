...
export default function AuthzCachePage() {
  ...
  return (
    <div className="flex flex-col">
      <Breadcrumb items={[{ title: "Cache", href: "/authz-cache" }]} />
      <AlertModal
        isOpen={confirmOpen}
        ...
        <Card>
          <CardHeader className="flex flex-row items-start justify-between gap-4">
            <div className="flex flex-col gap-1.5">
              ...
              <CardDescription>
                Cached roles, permissions and profiles per user. Every
                permission change made through the API applies on the next
