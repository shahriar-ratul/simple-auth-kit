...
import { emptyCustomerFields, type CustomerFormFields } from "./customer-schema";
...
export const EditCustomerPage = observer(function EditCustomerPage() {
  ...
  // Keyed on the active workspace, same as `CustomerDetailPage`: switching has to re-fetch rather
