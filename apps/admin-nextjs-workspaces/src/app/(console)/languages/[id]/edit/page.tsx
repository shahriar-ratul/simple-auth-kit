...
import { DIRECTION_OPTIONS, type LanguageFormValues } from "../../language-schema";
...
export default observer(function EditLanguagePage() {
  ...
  const [form, setForm] = useState<LanguageFormValues | null>(null);
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <Select value={form.direction} onValueChange={(value) => set("direction", value as "ltr" | "rtl")} disabled={saving}>
