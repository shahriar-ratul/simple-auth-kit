...
import { GENDER_OPTIONS, type EditCustomerFormValues } from "../../customer-schema";
...
export default observer(function EditCustomerPage() {
  ...
  const [form, setForm] = useState<EditCustomerFormValues | null>(null);
  ...
  function set<K extends keyof EditCustomerFormValues>(key: K, value: EditCustomerFormValues[K]) {
          ...
          <CardContent>
            ...
            <form onSubmit={handleSubmit} className="space-y-8 w-full">
              <Card className="w-full">
                    ...
                    <div className="space-y-4">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="flex flex-col gap-1.5">
                          ...
                          <Select value={form.gender || undefined} onValueChange={(value) => set("gender", value)} disabled={saving}>
                ...
                <CardContent className="pt-6">
                  <PhotoUpload photo={form.photo} fallback="?" onChange={(next) => set("photo", next)} disabled={saving} />
                </CardContent>
