...
type RejectedFile = { name: string; reasons: string[] };
 ...
 * arrow, followed by a Preview section with an accepted-file thumbnail (remove button on the
 * thumbnail) and a rejected-files list. Unlike the plain admin app this variant has no
 * react-dropzone, so the dropzone is a hand-rolled click/drag target over a hidden file input.
 */
