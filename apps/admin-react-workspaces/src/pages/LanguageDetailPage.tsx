...
export const LanguageDetailPage = observer(function LanguageDetailPage() {
  ...
  // Keyed on the active workspace, same as `LanguagesPage`: the record below is whatever this
  // workspace says about the language, so switching has to re-fetch rather than show stale data.
  useEffect(() => {
    void load();
