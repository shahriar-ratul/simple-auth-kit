...
import type { CreateLanguageInput } from "@simple-auth-kit/auth-client";
...
export const AddLanguagePage = observer(function AddLanguagePage() {
  ...
  async function handleSubmit(event: FormEvent) {
    ...
    try {
      ...
      // so this new language belongs to whichever workspace the console is currently in.
          ...
          <form onSubmit={handleSubmit} className="space-y-8 w-full">
            <Card className="w-full">
              ...
              <CardFooter className="flex justify-center gap-4 mt-8 pb-8">
                <Button type="button" variant="outline" onClick={() => navigate("/languages")} disabled={loading}>
                  Cancel
                </Button>
